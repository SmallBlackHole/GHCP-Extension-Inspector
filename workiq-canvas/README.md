...
A standalone "quick and dirty" Copilot canvas that lets a user browse **Work IQ**
(Microsoft 365) tools and add one to their current Foundry project. Sibling to the
Agent Inspector extension; same canvas pattern.
